...
the results with the following columns:
...
| Match confidence | A categorical measure of locus call quality (see [confidence score](Interpreting-the-results.md#confidence-score)). |
| Problems | Characters indicating issues with the locus match (see [problems](Interpreting-the-results.md#problems)). |
...
!!! note
    Numbers beside gene names indicate the percent identity and percent
    coverage of the gene in the assembly.
...
be used with [kaptive-convert](Usage.md#kaptive-convert). Unlike
